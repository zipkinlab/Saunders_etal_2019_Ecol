...
# call jags
AMWO.harvest.wings.34cor.long <- jagsUI(bugs.data, inits=inits, parameters, "AMWO.harvest.wings.jags", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel=TRUE, store.data=TRUE)
save(AMWO.harvest.wings.34cor.long, file="AMWO harvest wings deterministic model long run.Rda")
print(AMWO.harvest.wings.34cor.long)
load(file="AMWO harvest wings deterministic model.Rda")
